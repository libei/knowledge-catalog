...
import {relationshipAspectTypes} from './kc_relationships';
import {ACTION_TYPE_ID, RELATIONSHIP_TYPE_ID} from './kc_custom_types';
...
function semanticAspectTypes(entryType: string): string[]|undefined {
  ...
  switch (t) {
    ...
    case RELATIONSHIP_TYPE_ID:
      // Likewise for a relationship: its entry type is custom, and
      // kc_relationships.ts names the one aspect that holds the whole edge.
      return relationshipAspectTypes(typeBase);
    default:
      return undefined;
  }
}
